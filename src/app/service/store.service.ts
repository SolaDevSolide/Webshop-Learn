...
export class StoreService {
  ...
  getProductsByCategory(category: string, limit: string = "12", sort: string = "desc"): Observable<Array<Product>> {
    const url = `${this.STORE_BASE_URL}/products/category/${category}?sort=${sort}&limit=${limit}`;
